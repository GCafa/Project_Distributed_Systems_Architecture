#!/usr/bin/env python3
"""
Launcher eseguibile per il progetto quorum stateless.

Avvia 3 repliche, il coordinator stateless e poi apre il client
...
REPLICA_PORTS = [6421, 6422, 6423]


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Avvia il cluster quorum stateless e il client interattivo"
    )
...
def main() -> int:
    ...
    try:
        ...
        print(
            f"Coordinator stateless pronto su {args.host}:{args.coordinator_port}",
            flush=True,
        )
